...
StkObject* StkWebAppTest5::Execute(StkObject* ReqObj, int Method, wchar_t UrlPath[StkWebAppExec::URL_PATH_LENGTH], int* ResultCode, wchar_t Locale[3], wchar_t* HttpHeader)
{
	StkObject* RetObj = NULL;
	if (StkPlWcsStr(UrlPath, L"/bigdata/") != NULL) {
		RetObj = new StkObject(L"BigData");
